...
И, наконец, команда **git diff** позволяет увидеть разницу между сохранениями.

## Заключение
Мы рассмотрели основные функции Git
## Заключение 
Основные моменты мы рассмотрели, продолжение на следующих семинарах.
